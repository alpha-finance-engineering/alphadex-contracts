...
export interface AlphaDexFactoryInterface extends utils.Interface {
  contractName: "AlphaDexFactory";
  functions: {
...
export interface AlphaDexFactory extends BaseContract {
  contractName: "AlphaDexFactory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlphaDexFactoryInterface;
