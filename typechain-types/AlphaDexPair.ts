...
export interface AlphaDexPairInterface extends utils.Interface {
  contractName: "AlphaDexPair";
  functions: {
...
export interface AlphaDexPair extends BaseContract {
  contractName: "AlphaDexPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlphaDexPairInterface;
